        ...
        if($email_count){
          ...
          if($pass_decode){
            ...
            <?php
              ...
              ?>
              <script>
                  document.getElementById('error-text').innerHTML= "password incorrect";
              </script>
    <?php
          }
        }else{
            ?>
            <script>
            document.getElementById('error-text').innerHTML= "Email incorrect";
